...
public class SEHelper {
    ...
    public void helpMe(CommandSender event, String section) {
        ...
        if (section.equals("admin")) {
            if (plugin.checkPermissions("stocks.admin.add", player)) {
            ...
            if (plugin.checkPermissions("stocks.admin.remove", player)) {
            ...
            if (plugin.checkPermissions("stocks.admin.modify", player)) {
            ...
            if (plugin.checkPermissions("stocks.admin.limit", player)) {
            ...
            if (plugin.checkPermissions("stocks.admin.private", player)) {
            ...
            if (plugin.checkPermissions("stocks.admin.public", player)) {
            ...
            if (plugin.checkPermissions("stocks.users.top5", player)) {
            ...
            if (plugin.checkPermissions("stocks.users.lookup", player)) {
            ...
            if (plugin.checkPermissions("stocks.users.trade", player)) {
            ...
            if (plugin.checkPermissions("stocks.users.gift", player)) {
