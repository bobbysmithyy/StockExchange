...
public class SEPluginListener extends ServerListener {
    ...
    public SEPluginListener(StockExchange instance) {
        plugin = instance;
    }
    ...
    public void onPluginDisable(PluginDisableEvent event) {
        ...
        if (this.Methods != null && this.Methods.hasMethod()) {
            ...
            if(check) {
                ...
                System.out.println("[StockExchange] Payment method was disabled. No longer accepting payments.");
            }
        }
    }
    ...
    public void onPluginEnable(PluginEnableEvent event) {
        ...
        if (!this.Methods.hasMethod()) {
            if(this.Methods.setMethod(event.getPlugin())) {
                ...
                System.out.println("[StockExchange] Payment method found (" + this.plugin.Method.getName() + " version: " + this.plugin.Method.getVersion() + ")");
            }
        }
    }
}
